...
public class InspectListAdapter extends BaseAdapter {
    List<InspectBean.Data> listData = new ArrayList<>();


    public void refresh(List<InspectBean.Data> ls) {
        if (ls == null) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_inspect_list, null);
        ...
        InspectBean.Data bean = listData.get(position);
